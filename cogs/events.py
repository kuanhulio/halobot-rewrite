...
class Events(commands.Cog):
    ...
    async def on_message_delete(self, message):
        ...
        embed.add_field(name="Posted at",
                        value="{}".format(message.created_at))
        await MOD_LOG_CHANNEL.send(embed=embed)
    ...
    async def on_message_edit(self, before, after):
        ...
        embed.add_field(name="Message After Edit",
                        value="{}".format(after.clean_content))
        embed.add_field(name="User ID", value="{}".format(before.author.id))
        embed.add_field(name="Originally Posted at",
                        value="{}".format(before.created_at))
    ...
    async def on_guild_channel_create(self, channel):
        ...
        embed = discord.Embed(
            ...
            colour=discord.Colour.green(),
            description="This is posted when a Channel gets made.")
    ...
    async def on_guild_channel_delete(self, channel):
        ...
        embed = discord.Embed(
            ...
            colour=discord.Colour.red(),
            description="This is posted when a Channel gets deleted.")
    ...
    async def on_user_update(self, before, after):
        ...
        embed.add_field(name="Old Discriminator",
                        value="{}".format(before.discriminator))
        ...
        embed.add_field(name="New Discriminator",
                        value="{}".format(after.discriminator))
